...
from src.core.types import OHLCV, Timeframe, SignalType
...
class LivePatternDetector:
    ...
    async def _on_candle(self, candle_data: Dict[str, Any]):
        ...
        logger.info(f"   O: ${candle_data['open']:.2f}  H: ${candle_data['high']:.2f}  "
    ...
    def _print_stats(self):
        ...
        logger.info(f"   Signals: 📈{self.stats['buy_signals']} BUY | "
